...
class Birthdays:
    ...
    def vaccinations(self, merged_df, family_df):
        ...
        self.vaccinated_families_set = set(irresponsible_df.sample(n=int(irresponsible_df.shape[0] * percentage_of_vaccinated_families))["fam_id"])
...
if __name__ == '__main__':
    ...
    with open('../Results/Data/Vax_Not_Resp/bday_infections_irresponsible_2.json', 'w') as convert_file:
    ...
    # final_df.to_csv("../Results/Data/Vax_Not_Resp/bday_irresponsible_simulation_df_1.csv", index=False)
