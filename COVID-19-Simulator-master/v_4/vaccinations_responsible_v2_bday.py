...
class Birthdays:
    ...
    def vaccinations(self, merged_df, family_df):
        ...
        self.vaccinated_families_set = set(responsible_df.sample(n=int(responsible_df.shape[0] * percentage_of_vaccinated_families))["fam_id"])
...
if __name__ == '__main__':
    if len(sys.argv) == 1:
        print("usage: python3 vaccinations_responsible_bday_v2.py [Argument_1]")
    ...
    with open('../Results/Data/Vax_Resp/bday_infections_responsible.json', 'w') as convert_file:
